        ...
        <div class="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div class="lg:w-1/2">
            ...
            <div class="flex flex-wrap gap-4 mb-8">
              ...
              <a href="#" class="bg-gray-800 hover:bg-gray-700 text-white font-medium py-3 px-6 rounded-lg border border-gray-700 transition-all duration-300 hover:shadow-lg">
                获取简历
              </a>
            </div>
          ...
          <div class="lg:w-1/2">
            <div class="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700 hover:border-gray-600 transition-colors">
              <p class="text-gray-300 leading-relaxed">
                目前专业排名前 10% (GPA: 4.8 / 5.0)，持有华为 HCCDP-AI 高级认证。专注于分布式架构与 RAG 落地实践。
              </p>
